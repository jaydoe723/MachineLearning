...
# Parse records file for image and label
def parser(record):
    keys_to_features = {
...
while epoch < 3:
    print("Training...")
    model.train(input_fn=train_input_fn, steps=50)       # 50 steps per epoch
...
print("Final Validation accuracy: {0:.2%}".format(result["accuracy"]))
